...
تتضمن صفحة الامتحان الآن نموذج `COCO-SSD` اختيارياً يعمل داخل المتصفح لاكتشاف عناصر مثل الهاتف أو الكمبيوتر المحمول أو الكتاب. النموذج لا يرسل إطارات إلى الخادم؛ يسجل فقط اسم العنصر ودرجة الثقة التقريبية كتنبيه يحتاج مراجعة. فشل تحميل النموذج لا يمنع بدء الامتحان، لأن هذه الميزة مساعدة وليست دليلاً حاسماً.
